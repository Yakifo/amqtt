...
class BrokerSysPlugin:
    ...
    async def on_broker_pre_start(self, *args, **kwargs) -> None:
        self._clear_stats()

    async def on_broker_post_start(self, *args, **kwargs) -> None:
    ...
    async def on_broker_pre_stop(self, *args, **kwargs) -> None:
    ...
    async def on_broker_client_connected(self, *args, **kwargs) -> None:
    ...
    async def on_broker_client_disconnected(self, *args, **kwargs) -> None:
        self._stats[STAT_CLIENTS_CONNECTED] -= 1
